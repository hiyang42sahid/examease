import numpy as np
import cv2
from APP.grade_paper import ProcessPage
import json
import os


#alogrithm for sorting points clockwise
def scanSheet(file_name):
	
	folder = os.getcwd()+rf"\APP\media\uploads\{file_name}" 
	print(f"Scan Image : {folder}")
...
def scanSheet1():
	...
	folder = os.getcwd()+r"\APP\media\uploads" 
	print(folder)
	imagelist = []   
